...
public class DropLocationPreference {
    public static DropLocationPreference mInstance;
    public static Context mCtx;
    // shared pref mode
    int PRIVATE_MODE = 0;
    // Shared preferences file name
    private static final String PREF_NAME = "BSSshareARideDropLocationPreferenceManager";
    ...
    public DropLocationPreference(Context context) {
        mCtx = context;
    }

    public static synchronized DropLocationPreference getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new DropLocationPreference(context);
        }
        return mInstance;
    }
