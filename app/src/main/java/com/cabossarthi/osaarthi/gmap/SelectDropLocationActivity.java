...
public class SelectDropLocationActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = findViewById(R.id.btn_submit);
         PlaceAPI placesApi = new PlaceAPI.Builder().apiKey(getResources().getString(R.string.google_maps_key)).build(this);
        ...
        if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            ActivityCompat.requestPermissions(SelectDropLocationActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
        ...
        if (!Places.isInitialized()) {
            Places.initialize(SelectDropLocationActivity.this, getString(R.string.google_maps_key), Locale.getDefault());
        }
...
//                Log.e(TAG, "onPlaceSelected: showOnMap" + place.getLatLng().latitude + "\n" + place.getLatLng().longitude);
                try {
                    ...
                    try {
                        ...
                        DropLocationPreference.getInstance(getApplicationContext()).savePicupLocation(place.getLatLng().latitude + "," + place.getLatLng().longitude,
            ...
            try {
                ...
                if (addressList.size() > 0) {
                    ...
                    if (mainAddress != null) {
                        ...
                        DropLocationPreference.getInstance(SelectDropLocationActivity.this).savePicupLocation(
